...
<head>
  ...
  <title>Reset Password - ThinkBloom</title>
  <style>
                ...
                <tr>
                  <td class="email-content" style="padding: 48px 40px;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="padding-bottom: 32px;">
                          <p class="body-text" style="margin: 0; font-size: 16px; color: #64748b; line-height: 1.6;">We received a request to reset your password for your <strong style="color: #0f172a;">ThinkBloom</strong> account. Click the button below to create a new password.</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td align="center" style="padding-bottom: 32px;">
                          <a href="${data.resetLink}" class="cta-button" style="display: inline-block; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 48px; border-radius: 8px; box-shadow: 0 4px 14px 0 rgba(79, 70, 229, 0.4);">
                            Reset Password →
                          </a>
                        </td>
                      </tr>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 16px;">
                      <tr>
                        <td style="background: linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%); border-left: 4px solid #ef4444; padding: 16px 20px; border-radius: 8px;">
                          <p style="margin: 0; font-size: 14px; color: #7f1d1d; line-height: 1.6;">
                            <span style="font-size: 16px; margin-right: 8px; display: inline-block; vertical-align: middle;">🛡️</span>
                            <span style="display: inline-block; vertical-align: middle;"><strong>Security Tip:</strong> If you didn't request a password reset, please ignore this email. Your password will remain unchanged.</span>
                          </p>
                        </td>
                      </tr>
                    </table>
