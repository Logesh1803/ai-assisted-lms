export function userInviteEmailTemplate(data: {
  ...
  return {
    subject: "You're invited to Samera.ai",
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>You're Invited - Samera.ai</title>
  <style>
    /* Responsive styles */
          ...
          <tr>
            <td align="center" class="email-header" style="padding-bottom: 32px;">
              <div style="background: #0a0a0a; padding: 20px; border-radius: 12px; display: inline-block;">
                <img src="http://192:3000/assets/samera-ai.svg" alt="Samera" style="max-width: 180px; width: 100%; height: auto; display: block;">
              </div>
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1);">
                <tr>
                  <td class="email-content" style="padding: 48px 40px;">
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td align="center" style="padding-bottom: 24px;">
                          <h1 class="heading" style="margin: 0; font-size: 28px; font-weight: 700; color: #0f172a; line-height: 1.3;">✉️ You're Invited!</h1>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="padding-bottom: 32px;">
                          <p class="body-text" style="margin: 0; font-size: 16px; color: #64748b; line-height: 1.6;">You've been invited to join <strong style="color: #0f172a;">Samera</strong>. We're excited to have you on board! Click the button below to accept your invitation and get started.</p>
                        </td>
                      </tr>
                    </table>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td align="center" style="padding-bottom: 32px;">
                          <a href="${data.inviteLink}" class="cta-button" style="display: inline-block; background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 48px; border-radius: 8px; box-shadow: 0 4px 14px 0 rgba(59, 130, 246, 0.4);">
                            Accept Invitation →
                          </a>
                        </td>
                      </tr>
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="background: linear-gradient(135deg, #eff6ff 0%, #dbeafe 100%); border-left: 4px solid #3b82f6; padding: 16px 20px; border-radius: 8px; margin-bottom: 32px;">
